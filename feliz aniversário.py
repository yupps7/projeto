...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Feliz", font=("sans-serif", 20, "bold"))
    my_turtle_cursor.getscreen().update()
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Aniversário!", font=("sans-serif", 20, "bold"))
    my_turtle_cursor.getscreen().update()
...
my_turtle_screen.bgcolor("#E4E6EB")

parts_of_cake = []
parts_of_cake.append(["#FFC0CB", "#000000", 3, 30])
parts_of_cake.append(["#F5F5F5", "#000000", 3, 20])
parts_of_cake.append(["#FFC0CB", "#000000", 3, 60])

draw_layer_of_the_cake("#87CEEB", "#000000", 3, -220, y_coordinate - 70, 400, 10)
...
draw_toppings_on_cake("#FFC0CB", "#000000", -120, y_coordinate - 60, 10)
draw_toppings_on_cake("#F5F5F5", "#000000", -80, y_coordinate - 60, 10)
draw_toppings_on_cake("#87CEEB", "#000000", 25, y_coordinate - 60, 10)
draw_toppings_on_cake("#F5F5F5", "#000000", 59, y_coordinate - 60, 10)
draw_toppings_on_cake("#FFC0CB", "#000000", -135, y_coordinate - 80, 10)
draw_toppings_on_cake("#87CEEB", "#000000", -135, y_coordinate - 100, 10)
draw_toppings_on_cake("#F5F5F5", "#000000", -135, y_coordinate - 120, 10)
draw_toppings_on_cake("#87CEEB", "#000000", -80, y_coordinate - 80, 10)
draw_toppings_on_cake("#FFC0CB", "#000000", -65, y_coordinate - 110, 10)
draw_toppings_on_cake("#87CEEB", "#000000", -95, y_coordinate - 140, 10)
draw_toppings_on_cake("#FFC0CB", "#000000", 10, y_coordinate - 80, 10)
draw_toppings_on_cake("#E4E6EB", "#000000", -20, y_coordinate - 110, 10)
draw_toppings_on_cake("#FFC0CB", "#000000", 35, y_coordinate - 140, 10)
draw_toppings_on_cake("#FFC0CB", "#000000", 75, y_coordinate - 80, 10)
draw_toppings_on_cake("#87CEEB", "#000000", 75, y_coordinate - 110, 10)
draw_toppings_on_cake("#F5F5F5", "#000000", 75, y_coordinate - 140, 10)
draw_toppings_on_cake("#87CEEB", "#000000", -80, y_coordinate - 60, 10)
draw_candle_for_cake("#F5F5F5", "#000000", -40, y_coordinate - 60)
draw_stick_on_candle("#181A18", -26, y_coordinate + 15, 7)
draw_stick("#181A18", "#181A18", 0, y_coordinate - 60)
draw_circle_on_top_of_stick("#181A18", "#E4E6EB", 100, y_coordinate + 235, 100)
